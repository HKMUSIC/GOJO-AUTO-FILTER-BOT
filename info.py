...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002499343578')) # The movie you upload in it will be deleted from the bot.
...
SHORTENER_API = environ.get("SHORTENER_API", "435db9e5cc33630d6c708e9367ff613229a346ff")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'Adcash.in')
SHORTENER_API2 = environ.get("SHORTENER_API2", "435db9e5cc33630d6c708e9367ff613229a346ff")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'Adcash.in')
SHORTENER_API3 = environ.get("SHORTENER_API3", "435db9e5cc33630d6c708e9367ff613229a346ff")
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/vtsmve.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
